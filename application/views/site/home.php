...
<html lang="en">
    <head>
        ...
        <meta property="og:title" content="<?php echo $config[0]->site_title . " - " . $config[0]->site_tagline; ?>" />
        <meta property="og:description" content="<?php echo $config[0]->site_tagline; ?>" />
        <meta property="og:url" content="<?php echo site_url(); ?>" />
        <meta property="og:site_name" content="<?php echo $config[0]->site_title; ?>" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:description" content="<?php echo $config[0]->site_tagline; ?>" />
        <meta name="twitter:title" content="<?php echo $config[0]->site_title . " - " . $config[0]->site_tagline; ?>" />
                ...
                <div class="col-lg-8">
                    ...
                    <div class="panel panel-default">
                        <div class=" panel-body">
                            ...
                            <div class="row">    
                                <div class="col-lg-4">
                                    <a href="<?php echo site_url("result/" . $post->post_slug); ?>" class="thumbnail">
                                        <img src="<?php echo $post->post_thumb_image; ?>" alt="...">
                                    </a>
                                </div>
                                <div class="col-lg-8">
                                <?php 
